...
export default function GridItem({ project }: { project: Project }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative h-36 w-4/5 cursor-pointer rounded-md border-2 border-solid border-blue-700 bg-blue-900 p-2 transition-transform hover:scale-105 lg:h-56 lg:w-72 2xl:h-64 2xl:w-80"
    >
